...
const VocabularyPage: React.FC = () => {
    ...
    const [currentView, setCurrentView] = useState<"toStudy" | "learned">("toStudy");
...
const NavButton = styled.button<{ active: boolean }>`
  ...
  color: ${(props) => (props.active ? props.theme.colors.primary : props.theme.colors.placeholder)};
  font-size: 1.125rem;
...
const NavButtonText = styled.span<{ active: boolean }>`
  color: ${(props) => (props.active ? props.theme.colors.text : props.theme.colors.placeholder)};
